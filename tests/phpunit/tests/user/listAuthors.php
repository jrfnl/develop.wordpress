...
class Tests_User_ListAuthors extends WP_UnitTestCase {
	...
	function test_wp_list_authors_orderby() {
		...
		$this->AssertEquals(
			$expected['post_count'], wp_list_authors(
				array(
					'echo' => false,
					'orderby' => 'post_count',
				)
	...
	function test_wp_list_authors_optioncount() {
		...
		$this->AssertEquals(
			$expected['optioncount'], wp_list_authors(
				array(
					'echo' => false,
					'optioncount' => 1,
				)
	...
	function test_wp_list_authors_exclude_admin() {
		...
		$this->AssertEquals(
			$expected['exclude_admin'], wp_list_authors(
				array(
					'echo' => false,
					'exclude_admin' => 0,
				)
	...
	function test_wp_list_authors_show_fullname() {
		...
		$this->AssertEquals(
			$expected['show_fullname'], wp_list_authors(
				array(
					'echo' => false,
					'show_fullname' => 1,
				)
	...
	function test_wp_list_authors_feed_image() {
		...
		$this->AssertEquals(
			$expected['feed_image'], wp_list_authors(
				array(
					'echo' => false,
	...
	function test_wp_list_authors_feed_type() {
		...
		$this->AssertEquals(
			$expected['feed_type'], wp_list_authors(
				array(
					'echo' => false,
					'feed' => 'link to feed',
					'feed_type' => 'atom',
	...
	function test_wp_list_authors_style() {
		...
		$this->AssertEquals(
			$expected['style'], wp_list_authors(
				array(
					'echo' => false,
					'style' => 'none',
				)
